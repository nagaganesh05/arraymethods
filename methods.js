...
let array = ['g','a','n','e','s','h'].includes('s')
console.log(array)
...
let arrAy = ['g','a','n','e','e','s','h'];
let arrAy2 = arrAy.join(" ");
console.log(arrAy2);

let arrAy3 = ['g','a','n','e','e','s','h'];
